...
def export_all(request):     
    ...
    for m in mapp:
        ...
        ws.write(row_num, 0, dec_id,font_style4)
        ws.write(row_num, 1, sol_id,font_style4) 
        ws.write(row_num, 2, sol_option,font_style4)
        ws.write(row_num, 3, sc_id,font_style4) 
        ws.write(row_num, 4, criterion,font_style4)
        ws.write(row_num, 5, result,font_style4) 
        #ws.write(row_num, 6, created_date,date_style4)
        ws.write(row_num, 7, IdforUser(created_by),font_style4) 
        #ws.write(row_num, 8, updated_date,date_style4)
        ws.write(row_num, 9, IdforUser(updated_by),font_style4) 
    ...
    for m in idn:
        ...
        ws.write(row_num, 1, sol_id,font_style4) 
        ws.write(row_num, 2, sol_option,font_style4)
        ws.write(row_num, 3, ec_id,font_style4) 
        ws.write(row_num, 4, measure,font_style4)
        ws.write(row_num, 5, data,font_style4)
        ws.write(row_num, 6, criterion,font_style4)
        ws.write(row_num, 7, result,font_style4) 
        #ws.write(row_num, 8, created_date,date_style4)
        ws.write(row_num, 9, IdforUser(created_by),font_style4) 
