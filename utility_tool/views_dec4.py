...
from utility_tool.functions import check_required, group_cal, individual_cal, further_cal, update_text_criteria, redistribution_func, IdforUser, StValue, PartValue
...
def usageinfo(request):     
    ...
    iw1  = Importance_Scores.objects.all()
    iw_count = iw1.count()                                                                                                                           
    ...
    stdec1 = Stakeholders_Decisions.objects.all()
    ...
    solopt1 = Solution_Options.objects.all()
    ...
    evacr1 = Evaluation_Criteria.objects.all()
    ...
    costs1 = Cost_Utility.objects.all()
    ...
    evm1 = Evaluation_Measures.objects.all()
...
def summary_report(request, dec_id):
    ...
    add_hyperlink(d, 'https://www.decisionmakertool.org/Steps.html#Utility', "https://www.decisionmakertool.org/Steps.html#Utility")
...
i.dec_id=%s AND s.iw_type = 'Y' AND i.email = s.email AND (i.deleted = 'N' OR i.deleted IS NULL) group by i.eva_id""", [dec_id])                      
    ...
    ws.write(18, 0, "", font_style11)
    ws.write(18, 1, "The % of votes for each stakeholder is the number of votes assigned to a stakeholder divided by the total number of votes across all stakeholders. Take [the first stakeholder] as an example.", font_style11)  
    counter = 2
    tot_count = 22
    while counter < tot_count:
        ws.write(18, counter, "", font_style11)
        counter = counter + 1

    ws.write(19, 0, "", font_style11)
    ws.write(19, 1, "", font_style11)
    ws.write(19, 2, "7/(7+8+15) = 23%", font_style11) 
    counter = 3
    while counter < tot_count:
        ws.write(19, counter, "", font_style11)
        counter = counter + 1
   
    ws.write(20, 0, "", font_style11)
    ...
    counter = 2
    while counter < tot_count:
        ws.write(20, counter, "", font_style11)
        counter = counter + 1

    ws.write(21, 0, "", font_style11)
    ws.write(21, 1, "", font_style11)
    ws.write(21, 2, "(40*0.23) + (50*0.27) + (50*0.5) = 47.7", font_style11)  
    counter = 3
    while counter < tot_count:
        ws.write(21, counter, "", font_style11)
        counter = counter + 1

    ws.write(22, 0, "", font_style11)
    ws.write(22, 1, "The importance weight for each criterion is its vote-weighted Importance Score divided by the sum of all vote-weighted Importance Scores. Take [the criterion with the highest importance weight] as an example.", font_style11) 
    counter = 2
    while counter < tot_count:
        ws.write(22, counter, "", font_style11)
        counter = counter + 1

    ws.write(23, 0, "", font_style11)
    ws.write(23, 1, "", font_style11)
    ws.write(23, 2, "47.7/(23.0+33.0+32.3+47.7) = 0.35", font_style11) 
    counter = 3
    while counter < tot_count:
        ws.write(23, counter, "", font_style11)
        counter = counter + 1

    ws.write(24, 0, "", font_style11)
    ws.write(24, 1, "Note that discrepancies may occur due to rounding.", font_style11)  
    counter = 2
    while counter < tot_count:
        ws.write(24, counter, "", font_style11)
        counter = counter + 1
    ...
    ws.write(30, 0, "", font_style11)
    ws.write(30, 1, "DecisionMaker uses the data you entered in the Evaluation Data Table to calculate utility. The overall utility value earned by a Solution Option is the sum of the utility scores it earns on each of the", font_style11)   
    counter = 2
    while counter < tot_count:
        ws.write(30, counter, "", font_style11)
        counter = counter + 1

    ws.write(31, 0, "", font_style11)
    ws.write(31, 1, "", font_style11)
    ws.write(31, 2, "Evaluation Criteria (Criterion-level unweighted utility values) multiplied by the importance weights assigned by stakeholders to the criteria.", font_style11)  
    counter = 3
    while counter < tot_count:
        ws.write(31, counter, "", font_style11)
        counter = counter + 1

    ws.write(32, 0, "", font_style11)
    ws.write(32, 1, "", font_style11)
    ws.write(32, 2, "", font_style11)
    ws.write(32, 3, "Criterion-level unweighted utility value", font_style11)
    counter = 4
    while counter < tot_count:
        ws.write(32, counter, "", font_style11)
        counter = counter + 1

    counter = 0
    while counter < tot_count:
        ws.write(33, counter, "", font_style11)
        counter = counter + 1

    ws.write(34, 0, "", font_style11)
    ws.write(34, 1, "Each measure you used in your evaluation is rescaled to convert your results to a common utility scale with a minimum of 0 and maximum of 10, where 0 means that you and", font_style11)
    counter = 2
    while counter < tot_count:
        ws.write(34, counter, "", font_style11)
        counter = counter + 1

    ws.write(35, 0, "", font_style11)
    ws.write(35, 1, "your stakeholders are not at all satisfied and 10 means you are completely satisfied. The likely lowest score and likely highest score you entered for each measure are used to set the extremes of the scale and a straight", font_style11)
    counter = 2
    while counter < tot_count:
        ws.write(35, counter, "", font_style11)
        counter = counter + 1

    ws.write(36, 0, "", font_style11)
    ws.write(36, 1, "", font_style11)
    ws.write(36, 2, "line connects the two points. This assumes that utility changes in direct proportion to the changes in the evaluation measure.", font_style11)
    counter = 3
    while counter < tot_count:
        ws.write(36, counter, "", font_style11)
        counter = counter + 1

    ws.write(37, 0, "", font_style11)
    ws.write(37, 1, "When the rating or score on an evaluation measure is positively associated with the utility values (i.e., higher scores are better), the likely lowest score you entered is assumed to provide zero utility and the likely highest score you entered is assumed to provide a utility", font_style11)
    counter = 2
    while counter < tot_count:
        ws.write(37, counter, "", font_style11)
        counter = counter + 1

    ws.write(38, 0, "", font_style11)                                                                                                                    
    ws.write(38, 1, "", font_style11)      
    ws.write(38, 2, "value of 10. The criterion-level unweighted utility value for a Solution Option is:", font_style11)
    counter = 3
    while counter < tot_count:
        ws.write(38, counter, "", font_style11)
        counter = counter + 1

    counter = 0
    while counter < tot_count:
        ws.write(39, counter, "", font_style11)
        counter = counter + 1

    ws.write(40, 0, "", font_style11)
    ws.write(40, 1, "", font_style11)      
    ws.write(40, 2, "", font_style11)      
    ws.write(40, 3, "Criterion-level unweighted utility value=10 ×((Observed rating or score-Likely lowest score)/(Likely highest score - Likely lowest score))", font_style11)
    counter = 4
    while counter < tot_count:
        ws.write(40, counter, "", font_style11)
        counter = counter + 1

    counter = 0
    while counter < tot_count:
        ws.write(41, counter, "", font_style11)
        counter = counter + 1
    
    ws.write(42, 0, "", font_style11)
    ws.write(42, 1, "When the rating or score on an evaluation measure is negatively associated with the utility values (i.e., lower scores are better), the likely lowest score you entered is assumed to provide a utility", font_style11)
    counter = 2
    while counter < tot_count:
        ws.write(42, counter, "", font_style11)
        counter = counter + 1

    ws.write(43, 0, "", font_style11)
    ws.write(43, 1, "", font_style11)        
    ws.write(43, 2, "value of 10 while the likely highest score you entered is now assumed to provide zero utility. The criterion-level unweighted utility value for a Solution Option is:", font_style11)
    counter = 3
    while counter < tot_count:
        ws.write(43, counter, "", font_style11)
        counter = counter + 1

    counter = 0
    while counter < tot_count:
        ws.write(44, counter, "", font_style11)
        counter = counter + 1

    ws.write(45, 0, "", font_style11)
    ws.write(45, 1, "", font_style11)
    ws.write(45, 2, "Criterion-level unweighted utility value=10 ×((Likely highest score-Observed rating or score)/(Likely highest score - Likely lowest score))", font_style11)
    counter = 3
    while counter < tot_count:
        ws.write(45, counter, "", font_style11)
        counter = counter + 1

    counter = 0
    while counter < tot_count:
        ws.write(46, counter, "", font_style11)
        counter = counter + 1
    
    ws.write(47, 0, "", font_style11)
    ws.write(47, 1, "Take the criterion-level unweighted utility of [the first Solution Option in Table 2] for [the Evaluation Criterion with the highest importance weight] as an example. The evaluation measure is", font_style11)
    counter = 2
    while counter < tot_count:
        ws.write(47, counter, "", font_style11)
        counter = counter + 1

    ws.write(48, 0, "", font_style11)
    ws.write(48, 1, "", font_style11)
    ws.write(48, 2, "", font_style11)
    ws.write(48, 3, "[populate the evaluation measure].", font_style11)
    counter = 4
    while counter < tot_count:
        ws.write(48, counter, "", font_style11)
        counter = counter + 1

    ws.write(49, 0, "", font_style11)
    ws.write(49, 1, "The likely lowest score is [populate the likely lowest score], and the likely highest score is [populate the likely highest value]. The [higher or lower depending on “yes/no” to this question] the score is,`", font_style11)
    counter = 2
    while counter < tot_count:
        ws.write(49, counter, "", font_style11)
        counter = counter + 1

    ws.write(50, 0, "", font_style11)
    ws.write(50, 1, "the better. The likely lowest score of [populate the likely lowest score] is assigned a utility value of [0 or10 depending on “yes/no” to the “higher scores are better” question] and the likely highest", font_style11)
    counter = 2
    while counter < tot_count:
        ws.write(50, counter, "", font_style11)
        counter = counter + 1
                                                    
    ws.write(51, 0, "", font_style11)
    ws.write(51, 1, "", font_style11)  
    ws.write(51, 2, "", font_style11)  
    ws.write(51, 3, "score of [populate the likely highest value] is assigned a utility value of [10 or 0 depending on “yes/no” to the “higher scores are better” question].", font_style11)
    counter = 4
    while counter < tot_count:
        ws.write(51, counter, "", font_style11)
        counter = counter + 1
                                             
    ws.write(52, 0, "", font_style11)
    ws.write(52, 1, "A straight line is used to connect the two points, under the assumption that utility changes in direct proportion to the changes in the evaluation measure. The score or rating", font_style11)
    counter = 2
    while counter < tot_count:
        ws.write(52, counter, "", font_style11)
        counter = counter + 1
                                                                                                                                              
    ws.write(53, 0, "", font_style11)
    ws.write(53, 1, "of [populate the score or rating of the first Solution Option for the criterion that has the highest utility value] for [the first Solution Option in Table 3] is transformed into a utility value of [populate the criterion-level utility", font_style11)
    counter = 2
    while counter < tot_count:
        ws.write(53, counter, "", font_style11)
        counter = counter + 1
                                                                                                                                              
    ws.write(54, 0, "", font_style11)
    ws.write(54, 1, "", font_style11)  
    ws.write(54, 2, "", font_style11)  
    ws.write(54, 3, "value of this Solution Option for this criterion] using the following formula.", font_style11)
    counter = 4
    while counter < tot_count:
        ws.write(54, counter, "", font_style11)
        counter = counter + 1
    
    ws.write(55, 0, "", font_style11) 
    ws.write(55, 1, "", font_style11)        
    ws.write(55, 2, "[Choose the right formula depending on “yes/no” to the “higher scores are better” question and insert the numbers]", font_style11)
    counter = 3
    while counter < tot_count:
        ws.write(55, counter, "", font_style11)
        counter = counter + 1

    counter = 0
    while counter < tot_count:
        ws.write(56, counter, "", font_style11)
        counter = counter + 1

    counter = 0
    while counter < tot_count:
        ws.write(57, counter, "", font_style11)
        counter = counter + 1

    ws.write(58, 0, "", font_style11)
    ws.write(58, 1, "", font_style11)
    ws.write(58, 2, "", font_style11) 
    ws.write(58, 3, "Overall Utility Value", font_style11)
    counter = 4
    while counter < tot_count:
        ws.write(58, counter, "", font_style11)
        counter = counter + 1

    counter = 0
    while counter < tot_count:
        ws.write(59, counter, "", font_style11)
        counter = counter + 1

    ws.write(60, 0, "", font_style11)
    ws.write(60, 1, "The overall utility value is the sum of the criterion-level utility values multiplied by the importance weights. Take [the first Solution Option in Table 2] as an example. The total overall utility value is", font_style11)
    counter = 2
    while counter < tot_count:
        ws.write(60, counter, "", font_style11)
        counter = counter + 1

    ws.write(61, 0, "", font_style11)
    ws.write(61, 1, "", font_style11) 
    ws.write(61, 2, "", font_style11) 
    ws.write(61, 3, "calculated using the following formula:", font_style11)
    counter = 4
    while counter < tot_count:
        ws.write(61, counter, "", font_style11)
        counter = counter + 1

    ws.write(62, 0, "", font_style11)
    ws.write(62, 1, "", font_style11) 
    ws.write(62, 2, "[Insert the formula using the real numbers – you can use what’s on the R&G pages as a model:", font_style11)
    counter = 3
    while counter < tot_count:
        ws.write(62, counter, "", font_style11)
        counter = counter + 1

    ws.write(63, 0, "", font_style11)
    ws.write(63, 1, "", font_style11) 
    ws.write(63, 2, "Overall utility value for [the first Solution Option in Table 2] = (6.7 *0.17) + (9 * 0.33) + (8.5 * 0.50) = 8.36]", font_style11)
    counter = 3
    while counter < tot_count:
        ws.write(63, counter, "", font_style11)
        counter = counter + 1
    # disconnect from server'''
    database.close()
...
def export_sr(request):
    dec = Decisions.objects.filter(real_dec_yn = 'Y')
...
def export_sr_t(request):
    dec = Decisions.objects.filter(real_dec_yn = 'N')                                                                                     
    real_dec = dec.exclude(demoDec = 'Y')
    f = io.BytesIO()
    zipObj = ZipFile(f, 'a', compression=zipfile.ZIP_DEFLATED)
    for r in real_dec:
...
def export_all(request):     
    ...
    dec = Decisions.objects.filter(demoDec = 'Y')
    demo_dec_list = []
    for d in dec:
        demo_dec_list.append(d.id)
    ...
    database = MySQLdb.connect (host="amritha.mysql.pythonanywhere-services.com", user = "amritha", passwd = "lilies19", charset="utf8", db = "amritha$costutility")
    cursor = database.cursor ()
    sql = """SELECT d.id, short_title, title,  name_decisionmaker, type_of_dec,  decision_prob,  evidence,  goal,  target_audience,  stakeholders, participating_stakeholders,  potential_sources,  by_when,  real_dec_yn,  demoDec, created_date,  created_by,  updated_date,  updated_by,  shared, state, zip, country, organisation, position, type_of_org, other_org, other_pos, education, age, gender, race, other_race, publicOrPrivate FROM utility_tool_decisions d, utility_tool_users u where d.created_by = u.user and (d.demoDec is null or d.demoDec = 'N')"""
    ...
    atop = xlwt.Alignment()
    atop.wrap = True
    atop.vert = a.VERT_TOP
    atop.horz = a.HORZ_LEFT 
    font_style4 = xlwt.XFStyle()
    font_style4.pattern = pattern3
    font_style4.alignment = atop
    date_style4 = xlwt.XFStyle()
    date_style4.pattern = pattern3
    date_style4.num_format_str = 'mm/dd/yyyy'
    date_style4.alignment = atop
    date_style3 = xlwt.XFStyle()
    date_style3.pattern = pattern2
    date_style3.num_format_str = 'mm/dd/yyyy'
    font_style5 = xlwt.XFStyle()
    ...
    columns = [
          ...
          (u"Organization", 3000), 
          (u"Position", 3000), 
          (u"Type of Organization", 3000), 
          (u"Other Organization", 3000), 
          (u"Other Position", 3000), 
          (u"Education", 3000), 
          (u"Age", 3000), 
          (u"Gender", 3000), 
          (u"Race", 3000), 
          (u"Other Race", 3000), 
          (u"Public or Private Individual?", 3000), 
    ]
    ...
    try:
       ...
       for row in results:
          ...
          race = row[31] 
          other_race = row[32] 
          publicOrPrivate = row[33] 
          for col_num in xrange(len(row)):
              if col_num == 12 or col_num == 15 or col_num == 17:
                ws.write(row_num, col_num, row[col_num],date_style4)
              elif col_num == 16 or col_num == 18:
    ...
    row_num = 1 
    cursor2 = database.cursor ()
    sql2 = """SELECT dec_id, id,  st_id,  iw_type,  iw_date,  evacr_type,  evacr_date,  scrcr_type,  scrcr_date,  solopt_type,  solopt_date,  created_date,  created_by,  updated_date,  updated_by,  votes,  deleted FROM utility_tool_stakeholders_decisions where dec_id not in %(demo_dec_list)s"""      

    columns = [
          (u"Decision ID", 3000),  
          (u"Stakeholder Decision Id", 3000),
    ...
    row_num = 1 
    cursor2 = database.cursor ()
    sql2 = """SELECT dec_id, id, sol_option, source, option_details, filename1, file_attachment1, filename2, file_attachment2, filename3, file_attachment3, filename4, file_attachment4, linkname1, link1, linkname2, link2, linkname3, link3, linkname4, link4, archived, archived_date, archived_by, unarchived, unarchived_date, unarchived_by, deleted, created_date, created_by, updated_date, updated_by FROM utility_tool_solution_options where dec_id not in %(demo_dec_list)s"""      

    columns = [
          (u"Decision ID", 3000),  
          (u"Solution Option Id", 3000),
          (u"Solution Option", 8000),
          (u"Source", 8000),
          (u"Option Details", 8000),
          (u"File Name1", 3000),
          (u"File Attachment1", 5000),
          (u"File Name2", 3000),
          (u"File Attachment2", 5000),  
          (u"File Name3", 3000),
          (u"File Attachment3", 5000),  
          (u"File Name4", 3000),
          (u"File Attachment4", 5000),  
          (u"Link Name1", 3000),
          (u"Link1", 5000),
          (u"Link Name2", 3000),
          (u"Link2", 5000),  
          ...
          (u"Link4", 5000),    
          (u"Archived?", 3000),
          (u"Archived Date", 3000),
          (u"Archived By", 3000),
          (u"Un-Archived?", 3000),
          (u"Un-Archived Date", 3000),
          (u"Un-Archived By", 3000),
          (u"Deleted?", 3000),
          (u"Created Date", 3000),
          (u"Created By", 3000),
          (u"Updated Date", 3000),
    ...
    try:
       ...
       for row in results:
          row_num += 1
          for col_num in xrange(len(row)):
              if col_num == 22 or col_num == 25 or col_num == 28 or col_num == 30:
                ws.write(row_num, col_num, row[col_num],date_style4)
              elif col_num == 23 or col_num == 26 or col_num == 29 or col_num == 31:
                ws.write(row_num, col_num, IdforUser(row[col_num]),font_style4)
              else:
                ws.write(row_num, col_num, row[col_num],font_style4)                                                                                    
    except:
    ...
    row_num = 1 
    cursor2 = database.cursor ()
    sql2 = """SELECT dec_id, id, criterion,criterion2,fieldname,created_date,created_by, updated_date, updated_by FROM utility_tool_screening_criteria where dec_id not in %(demo_dec_list)s"""                    
    columns = [
          (u"Decision ID", 3000),  
          (u"Screening Criteria Id", 3000),
          (u"Criterion", 8000),
          (u"Criterion2", 8000),
          (u"Field Name", 3000),
          (u"Created Date", 3000),
    ...
    # Evaluation Criteria                                                                                                                                
    ws = wb.add_sheet("Evaluation Criteria")
    row_num = 1 
    cursor2 = database.cursor ()
    sql2 = """SELECT dec_id, id,  or_criterion,  criterion,  suggested_evam,  data,  criterion2,  combined,  orig_eva_id,  fieldname,  weight,  adjusted_weight,  created_date,  created_by,  updated_date,  updated_by,  deleted FROM utility_tool_evaluation_criteria where dec_id not in %(demo_dec_list)s"""

    columns = [
          (u"Decision ID", 3000),  
          (u"Id", 3000),
          (u"Overreaching Criterion", 15000),
          (u"Granular Criterion", 15000),
          (u"Suggested Measure", 15000),
          (u"Data", 15000),
          (u"Criterion2", 9000),
          (u"Combined Criterion", 15000),
          (u"Original EVA ID", 0),
          (u"Field Name", 3000),
          (u"Weight", 3000),
          (u"Adjusted Weight", 3000),
          (u"Created Date", 3000),
          (u"Created By", 3000),
          (u"Updated Date", 3000),
          (u"Updated By", 3000),
    ...
    row_num = 1 
    cursor2 = database.cursor ()
    sql2 = """SELECT dec_id, id,  eva_id,  criterion,  score,  deleted, created_date,  created_by,  updated_date,  updated_by,  email FROM utility_tool_importance_scores where dec_id not in %(demo_dec_list)s"""

    columns = [
          (u"Decision ID", 3000),  
          (u"Id", 3000),
          (u"Evaluation Criterion ID", 3000),
          (u"Criterion", 15000),
          (u"Decision ID", 3000),
          (u"Score", 3000),
          (u"Deleted?", 3000),
