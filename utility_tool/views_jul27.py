...
def export_all(request):     
    ...
    row_num = 0 
    cursor2 = database.cursor ()
    sql2 = """SELECT dec_id, id,  created_by, eva_id,  criterion,  score,  deleted, created_date,  updated_date,  updated_by,  email FROM utility_tool_importance_scores where dec_id not in %(demo_dec_list)s"""
